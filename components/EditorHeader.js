...
function EditorHeader({ userEmail }) {
    ...
    return (
        <header className='py-3 flex items-center sticky top-0 z-50 px-5 shadow-md bg-white justify-between'>
            <div className='flex justify-between items-center text-gray-800'>
                ...
                <div className='ml-2 sm:ml-5'>
                    <motion.h2 className='flex flex-col items-start justify-between text-md ml-2 font-medium' aria-label={filename}>
                        <motion.span
                            ref={textBoxRef}
                            className='py-0 px-2 border-1 text-sm border-gray-400 outline-1 outline-gray-100 transition duration-1000 text-gray-600 focus:text-gray-800'
                            name="filename"
                            role="textbox"
